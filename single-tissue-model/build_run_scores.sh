...
rm slurm/${TRAIT}.${ANCESTRY}.run_calculate_PLINK_scores.jobs
rm slurm/${TRAIT}.${ANCESTRY}.run_calculate_standard_scores.jobs
...
echo "${RES##* }" >> slurm/${TRAIT}.${ANCESTRY}.run_standard_scores.jobs
RES=$(sbatch slurm/${TRAIT}.${ANCESTRY}.run_PLINK_scores.sh)
echo "${RES##* }" >> slurm/${TRAIT}.${ANCESTRY}.run_PLINK_scores.jobs