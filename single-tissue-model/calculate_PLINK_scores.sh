...
#SURF
${PLINK_PATH} --bfile ${EUR_1KG_BFILE} --clump-p1 1 --clump-p2 1 --clump-r2 0.2 --clump-kb 250 --clump ${SUMSTATS} --clump-snp-field SNP --clump-field P \
        --extract ${SURF_PATH}/1000G_phase3_master_scores_1KG-pruned_quantile_normalized.GENERIC.${PARTITION}.SNPs --out ${RESULTS_PATH}/SURF/${TRAIT}.${ANCESTRY}.SURF.${PARTITION}.clump
...
#TURF
${PLINK_PATH} --bfile ${EUR_1KG_BFILE} --clump-p1 1 --clump-p2 1 --clump-r2 0.2 --clump-kb 250 --clump ${SUMSTATS} --clump-snp-field SNP --clump-field P \
        --extract ${TURF_PATH}/1000G_phase3_master_scores_1KG-pruned_quantile_normalized.${TISSUE}.${PARTITION}.SNPs --out ${RESULTS_PATH}/TURF/${TRAIT}.${ANCESTRY}.TURF.${PARTITION}.clump
